    ...
    <div data-form-page="3" className="bg-white text-black px-4 sm:px-8 py-6 sm:py-8 max-w-full sm:max-w-[210mm] mx-auto font-['Open_Sans'] shadow-lg min-h-[297mm]">
      ...
      <div className="mb-6 space-y-4">
        <div className="flex flex-col gap-2">
          <span className="font-bold">Employee Signature: <span className="text-red-500">*</span></span>
          <div className="w-full">
            {readOnly ? (
              <div className="border border-gray-400 p-2 min-h-[80px] flex items-center justify-center bg-gray-50">
            ...
            {validationErrors.employeeSignature && (
              <p className="text-red-500 text-sm mt-1">{validationErrors.employeeSignature}</p>
            )}
          </div>
        </div>
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-0">
          <span className="font-bold w-full sm:w-48">Employee Date: <span className="text-red-500">*</span></span>
          {readOnly ? (
      ...
      <div className="mb-6 space-y-3">
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-0">
          <span className="font-normal w-full sm:w-32">Reviewed by:</span>
          {readOnly ? (
            <span className="font-normal border-b border-gray-400 px-2 py-1 min-w-0 sm:min-w-[300px] break-words">
            ...
            <input
              ...
              className="font-normal border-b border-gray-400 px-2 py-1 min-w-0 sm:min-w-[300px] focus:outline-none focus:border-blue-500"
              placeholder="Enter reviewer name"
            />
          )}
        </div>
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-0">
          <span className="font-normal w-full sm:w-32">Title:</span>
          {readOnly ? (
            <span className="font-normal border-b border-gray-400 px-2 py-1 min-w-0 sm:min-w-[300px] break-words">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-0">
          <span className="font-normal w-full sm:w-32">Date:</span>
          {readOnly ? (
            <span className="font-normal border-b border-gray-400 px-2 py-1 min-w-0 sm:min-w-[300px] break-words">
      ...
      <div className="mb-6 space-y-4">
        <div className="flex flex-col gap-2">
          <span className="font-bold">Signature of Reviewer:</span>
          <div className="w-full">
            {readOnly ? (
              <div className="border border-gray-400 p-2 min-h-[80px] flex items-center justify-center bg-gray-50">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-0">
          <span className="font-bold w-full sm:w-48">Date:</span>
          {readOnly ? (
            <span className="font-normal border-b border-gray-400 px-2 py-1 min-w-0 sm:min-w-[300px] break-words">
